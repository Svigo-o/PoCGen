...
def _build_http_system_prompt(payload: str, has_sample: bool = False) -> str:
    base = (
        ...
        "  2) Check if the parameter passes through atoi() — if yes, choose a different parameter.\n"
        ...
        "  1) Try backticks first for firmware targets, e.g. '`wget ...`' — most reliable across firmware shells.\n"
